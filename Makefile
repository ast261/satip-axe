...
fs.cpio: $(CPIO_SRCS)
	fakeroot tools/do_min_fs.py \
	  ...
	  -e "apps/oscam-svn/Distribution/oscam-1.20_svn$(OSCAM_REV)-sh4-linux-gnu:sbin/oscamd" \
...
apps/oscam-svn/Distribution/oscam-1.20_svn$(OSCAM_REV)-sh4-linux-gnu: apps/oscam-svn/config.sh
